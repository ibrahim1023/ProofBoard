...
| Foundry harness-generator fixtures | 8 | `npm test` |
...
`npm test` currently covers 97 web, API, package, runner, parser, and eval assertions. Browser E2E checks are listed separately because Playwright runs them against a local production Next server.
