...
| Foundry harness-generator fixtures | 10 | `npm test` |
...
`npm test` currently covers 99 web, API, package, runner, parser, and eval assertions. Browser E2E checks are listed separately because Playwright runs them against a local production Next server.
