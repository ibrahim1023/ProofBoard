...
The package regression suite compiles the untouched scaffold and, when Forge is available, wires a local target vault fixture that executes deposit, withdraw, and donation actions before checking protocol-specific accounting assertions.
