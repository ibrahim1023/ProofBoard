...
| Skeptic statuses | 6 |
| Generated verification artifacts | 14 Foundry, SMTChecker, Scribble, Certora, Echidna, and Halmos files |
...
|---|---:|---|
| Unit and eval assertions | 100 passing | `npm test` |
