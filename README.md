...
- A bounded Solana token-vault review fixture with Anchor-style source, IDL, approved intent, candidate property, assumptions, and a planned but unexecuted LiteSVM run.
